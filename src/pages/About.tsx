...
import whyChoose2 from "../assets/about/why-choose-2.webp";
import photoAngath from "../assets/about/angath.webp";
import photoManjunath from "../assets/about/manjunath.webp";
import photoSaqib from "../assets/about/saqib.webp";
import photoKumar from "../assets/about/kumar.webp";
...
const team = [
  {
    ...
    photo: photoAngath,
    bio: [
      "By age eight, he was already spending weekends learning the ropes at a local garage — an obsession that took him to TOC Automotive College Malaysia and hands-on experience with Mazda and Nissan-Renault, before he founded Grime & Grease in 2019, growing it from a 150 sq. ft. garage to a 2,200 sq. ft. premium facility. ",
      'Some say his first word was "Car."',
    ],
  },
  {
    ...
    <>
      <section className="about-hero">
        ...
        <div className="about-hero-band">
          <p className="container">
            ...
            from a lifelong passion for cars and the pure joy of understanding
            how machines breathe, move, and endure. What began with childhood
            tire changes and weekend garage visits grew into a commitment to
            honest, high-quality automotive care.
            <br />
            <br />
            For us, servicing a car is almost sacred — an engine must function
            in perfect harmony, and watching it run for lakhs of kilometres is
            our greatest satisfaction.
            <br />
            <br />
            We believe in transparency above all: if something can&rsquo;t be
            fixed, we&rsquo;ll tell you. As both former customers and
            experienced mechanics, we understand your car from the inside out —
      ...
      <section className="what-we-do container">
        ...
        <div>
          ...
          <p>
            At Grime &amp; Grease, we handle complete car care with precision
            and honesty. Our services include engine diagnostics and repairs,
            general servicing, detailing, paint jobs and full bodywork, and
            accident restoration.
            <br />
            <br />
            Whether it&apos;s routine maintenance or a complex mechanical issue,
            our team brings skilled hands and a transparent process to every job
            — restoring performance, resolving issues, or simply refreshing how
            your car looks and feels.
          </p>
        </div>
      </section>
      ...
      <section className="why-choose container">
        <div>
          ...
          <p>
            ...
            we&apos;d give our own. Every service is handled by skilled hands
            who take the time to walk you through what&apos;s being done and
            why.
            <br />
            <br />
            Backed by precise diagnostics and honest advice, your car leaves us
            performing better, running cleaner, and built to last.
          </p>
        </div>
